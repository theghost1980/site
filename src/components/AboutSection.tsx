...
const musicians: Musician[] = [
  {
    ...
    bio: 'Apasionado cantante y percusionista que ha grabado producciones musicales en Venezuela y a nivel internacional. Musico de guataca con corazon!',
  ...
  },
  {
    ...
    bio: 'Músico desde muy temprana edad, que ha defendido, valorado y practicado el folklore venezolano. Pertenece al sistema de orquestas de Venezuela y su energía y pasión por la música, no tienen limites',
          ...
          <div className="mb-20 flex flex-col items-center gap-12 md:flex-row">
            ...
            <div className="md:w-3/5">
              <p className="text-base leading-relaxed text-gray-300 md:text-lg">
                El ensamble Compass Venezuela, es una agrupación que nace con el proposito de representar a Venezuela en una presentacion cultural que tendra lugar en la India, especificamente en Muddenahalli con motivo a la celebracion del aniversario numero 100 de Sai Baba. Nosotros hemos estado en el camino musical desde hace mucho e incluso somos una familia. Nuestro grupo quiere llevar un compendio de generos musicales que van desde el Joropo, la Gaita Zuliana, el Golpe Tocuyano, hasta la Parranda y el afrovenezolano.
              </p>
              <p className="mt-6 text-lg font-semibold italic text-cyan-400">
                Los Sueños y deseos hacia Dios, se hacen realidad
              </p>
              <p className="mt-4 text-base leading-relaxed text-gray-300 md:text-lg">
                Siempre hemos utilizado la musica como la expresion mas pura de nuestro sentir y nuestra cultura. Dios nos ha regalado un viaje unico para ir a India y poder llevar una muestra de folklore. Este viaje y esta oportunidad son un milagro. El Simple hecho de que podamos llevar a los mas jovenes a cantar y tocar para miles de personas, da fe de que el amor y las buenas acciones siempre seran recompensados.
              </p>
            </div>
          </div>
